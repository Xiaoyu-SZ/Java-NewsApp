...
package com.easytagdragview.widget;
...
import com.easytagdragview.listener.OnDragDropListener;
import com.java.tangningjing.R;

public class DragDropGirdView extends GridView implements OnDragDropListener,
        com.easytagdragview.widget.DragDropController.DragItemContainer {
    ...
    private com.easytagdragview.widget.DragDropController mDragDropController = new com.easytagdragview.widget.DragDropController(this);
    ...
    public com.easytagdragview.widget.DragDropController getDragDropController() {

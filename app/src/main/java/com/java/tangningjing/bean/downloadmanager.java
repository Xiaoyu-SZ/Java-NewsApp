...
//    public static ArrayList<expert> expertdownload(){
...
//                    pro.setAffiliation_zh(profile_obj.get("affiliation_zh").toString());
//                    pro.setBio(profile_obj.get("bio").toString());
//                    pro.setEdu(profile_obj.get("edu").toString());
//                    pro.setHomepage(profile_obj.get("homepage").toString());
//                    pro.setNote(profile_obj.getString("note"));
//                    pro.setPosition(profile_obj.getString("position"));
//                    pro.setWork(profile_obj.getString("work"));
//
...
//
//                    expert exp = new expert(obj.getString("id"), pro, ind, obj.getBoolean("is_passedaway"), obj.getString("name"), obj.getString("name_zh"));
//                    experts.add(exp);
//                }
//                catch(Exception e){
//                    e.printStackTrace();
